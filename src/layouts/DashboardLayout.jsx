  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-sans text-gray-800 dark:text-gray-100 overflow-hidden relative transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-[#F8F9FB] dark:bg-gray-900 transition-colors duration-300">
        {/* Header */}
        <header className="h-16 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between px-8 z-10 shrink-0 transition-colors duration-300">
          <div className="flex items-center gap-6 flex-1">
            ...
            <div className="relative max-w-md w-full">
              ...
              <input
                type="text"
                placeholder="Search"
                className="w-full bg-gray-50 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400 border-none rounded-lg py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-800 transition-colors duration-300"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <button className="px-3 py-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 rounded-lg flex items-center gap-1 border border-gray-100 dark:border-gray-600">
                AlCoder markazi <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </button>
              <button className="px-3 py-1.5 text-xs font-semibold text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 rounded-lg flex items-center gap-1 border border-gray-100 dark:border-gray-600">
          ...
          <div className="mb-8 flex items-center justify-between">
            ...
            {location.pathname === '/dashboard/teacher' && (
              <div className="flex items-center gap-3">
                ...
                <button className="px-4 py-2 bg-[#7C3AED] text-white rounded-lg text-sm font-semibold flex items-center gap-2 hover:bg-[#6D28D9] shadow-sm transition-all">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
                  O'qituvchi qo'shish
                </button>
              </div>
